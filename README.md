...
It would be extremely difficult to isolate inconsistent labeling since one would need to go row by row to check the issue, so it could be an extensive problem or the above examples could be an edge case. 
